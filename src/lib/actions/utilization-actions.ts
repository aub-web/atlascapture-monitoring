...
export type UpdateUtilizationState = { error: string } | null;

export async function updateUtilizationEntry(
  _prevState: UpdateUtilizationState,
  formData: FormData,
): Promise<UpdateUtilizationState> {
