...
import { getSalesCheckIn } from "@/lib/sales-data";
import { updateSalesCheckIn } from "@/lib/actions/sales-checkin-actions";
import { isAdminAuthenticated } from "@/lib/admin-auth";
import CheckInForm from "@/components/CheckInForm";

export default async function EditSalesCheckInPage({
  params,
}: {
  ...
  const checkIn = await getSalesCheckIn(checkInId);
